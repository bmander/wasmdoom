// WasmDOOM: Worthy Adversaries integration, 2026-09-05. GPL-2.0-or-later.
//
  ...
  mobjtype_t	type )
{
    mobj_t*	th;
    angle_t	an;
    fixed_t aimx = dest->x, aimy = dest->y;
    int		dist;
    ...
    P_WorthyAim(source, dest, th->info->speed, &aimx, &aimy);
    an = R_PointToAngle2 (source->x, source->y, aimx, aimy);
